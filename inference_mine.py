...
def face_detect(images):
    ...
    for img in images:
        ...
        with mp_face_detection.FaceDetection(min_detection_confidence=0.5,model_selection=1) as face_detection:
            ...
            if res.detections :
                bounding_box = res.detections[0].location_data.relative_bounding_box
...
def main():
    ...
    args.outfile = "results/" + args.face.split(".")[0].split("/")[-1] + args.checkpoint_path.split(".")[-2].split("/")[-1] + ".mp4"
